...
export const patches: Patch[] = [
  ...
  // TODO: api-ify
  {
    ...
    replace: {
      match: /(,(\(0,\i\.jsx\))\(\i\.\i,{primaryGuild:\i,userId:(\i)\.id,contextGuildId:\i.*?}\)),(\i)]/,
      replacement: (_, orig, createElement, user, badges) =>
        `${orig},${createElement}(require("platformIcons_icons").default,{user:${user},configKey:"profiles",extraClasses:["platform-icons-profile"]}),${badges}]`
    }
  },
...
export const webpackModules: Record<string, ExtensionWebpackModule> = {
  icons: {
    ...
    dependencies: [
      ...
      { id: "discord/modules/icons/web/GameControllerIcon" },
      { id: "discord/modules/icons/web/GlobeEarthIcon" },
      { id: "discord/modules/icons/web/MobilePhoneIcon" },
      { id: "discord/modules/icons/web/ScreenIcon" },
      { id: "discord/modules/icons/web/VrHeadsetIcon" },
      { id: "discord/utils/UserUtils" },
